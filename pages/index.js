...
export default function Home() {
  ...
  const handleGetRequest = async () => {
    const res = await fetch('https://tech0-gen-8-step3-testapp-py1-2.azurewebsites.net/api/hello', {
      method: 'GET',
    });
  ...
  const handleIdRequest = async (e) => {
    ...
    const res = await fetch(`https://tech0-gen-8-step3-testapp-py1-2.azurewebsites.net/api/multiply/${id}`, {
      method: 'GET',
    });
    const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('https://tech0-gen-8-step3-testapp-py1-2.azurewebsites.net/api/echo', {
      method: 'POST',
      headers: {
